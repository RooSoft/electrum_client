defmodule Electrum.Calls.Blockchain.ScriptHash.GetHistory do
  @moduledoc """
  ...
  ## Examples
    ...
    ...> |> Electrum.Calls.Blockchain.ScriptHash.GetHistory.encode_params()
    \"""
  ...
  ## Examples
    ...
    ...>  \"""
    ...>  |> Electrum.Calls.Blockchain.ScriptHash.GetHistory.parse_result()
    [
      %{
        height: 2347375,
