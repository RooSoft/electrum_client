defmodule Electrum.Calls.Blockchain.Transaction.Broadcast do
  @moduledoc """
  ...
  ## Examples
    ...
    ...> |> Electrum.Calls.Blockchain.Transaction.Broadcast.encode_params()
    \"""
  ...
  ## Examples
    ...
    ...>  \"""
    ...>  |> Electrum.Calls.Blockchain.Transaction.Broadcast.parse_result()
    {
      :ok,
